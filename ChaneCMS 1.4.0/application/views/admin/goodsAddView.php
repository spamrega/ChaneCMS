      ...
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
			...
			<form action="" method="POST">
				<p>Название товара <input type="text" name="item_title" class="form-control" placeholder="Counter-Strike" aria-describedby="basic-addon1"></p>
				<p>Цена товара (от 1 рубля) <input type="number" step="0.01" name="item_price" class="form-control" placeholder="399" aria-describedby="basic-addon1"></p>
				...
				<p>Описание товара для страницы товара <textarea type="text" name="item_desc" class="form-control" placeholder="Игра" aria-describedby="basic-addon1"></textarea></p>
				<p>Дополнительная информация для страницы товара <textarea type="text" name="item_desc_a" class="form-control" placeholder="Активация в приложении Steam" aria-describedby="basic-addon1"></textarea></p>
